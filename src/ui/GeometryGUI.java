...
public class GeometryGUI implements ActionListener {
    ...
    private JMenuItem exitItem, exportItem, aboutItem, clearHistoryItem;
    ...
    private JPanel create2DPanel() {
        ...
        btnReset.addActionListener(e -> { tfSumbuPanjang.setText(""); tfSumbuPendek.setText(""); });
    ...
    private JPanel createAboutPanel() {
        ...
        aboutText.setText("""
            ...
            ✓ 5 Pilar OOP (Encapsulation, Inheritance, 
    ...
    private void calculateKerucutElips(Elips alas, double t) {
        try {
            ...
            calculateShape(kerucut, String.format("a=%.2f, b=%.2f, t=%.2f", alas.getSumbuPanjang(), alas.getSumbuPendek(), t), "Kerucut Elips");
        } catch (Exception ex) {
    ...
    private void calculateTabungElips(Elips alas, double t) {
        ...
        calculateShape(tabung, String.format("a=%.2f, b=%.2f, t=%.2f", alas.getSumbuPanjang(), alas.getSumbuPendek(), t), "Tabung Elips");
    }
